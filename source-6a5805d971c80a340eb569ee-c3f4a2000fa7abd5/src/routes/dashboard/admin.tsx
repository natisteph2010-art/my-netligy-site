    ...
    <div className="min-h-screen bg-gray-50 text-slate-900 admin-shell">
      ...
      <div className={`transition-all duration-300 ${collapsed ? 'lg:pl-20' : 'lg:pl-64'}`}>
        ...
        <main className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto">
          ...
          {view === 'mentors' && <Placeholder title="Mentors" icon={I.mentors} desc="Approved mentors will be listed and managed here. Approve applications to populate this directory." />}
          {view === 'students' && <Placeholder title="Students" icon={I.students} desc="Registered students will appear here for review and support." />}
...
function Applications(props: {
  ...
  const { applications, loading, statusFilter, setStatusFilter, expanded, setExpanded, actionLoading, onReview, onRefresh, search } = props
