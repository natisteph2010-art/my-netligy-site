...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-XGklRDLH.js");
...
const manifest = {
  "49106938b52c8bf2e7795ac418917757130e43844a341613882f98c174227919": {
    ...
    importer: () => import("./assets/auth-BmJ5mJji.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./assets/router-BnqWM5vx.js").then((n) => n.r),
