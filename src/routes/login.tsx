...
import { login, signup, AuthError, handleAuthCallback } from '@netlify/identity'
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (isRecoveryFlow) {
        ...
        const identityModule = await import('@netlify/identity') as typeof import('@netlify/identity') & {
          updateUser?: (payload: { password: string }) => Promise<unknown>
        }
